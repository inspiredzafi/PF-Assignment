...
public class Programs{
    ...
    /*          
        12. Write a program to find the volume of a cylinder using the 'const' qualifier.
        Formula:        
                            Volume = πR2 x H ;       
     */
    ...
    /*          
        13. Write a program to Calculate the Area of circle using 'const' qualifier for PI. 
        Area of Circle : 
                          Area = πR^2
     */
    ...
    */
    ...
    public static void problem17(){
        ...
        // Variables
        float number = 15.58971f ;          // This 'f' flag at the end of the decimal integer indicates the value is of type float. 
    ...
    /*          
       18. Write a program to assign values to variables 'vi'  and 't' and comput the value of 's' by using this foumula:       
                    s = vi * t * 1/2* a *(t^2)
     */
    ...
    /*          
       19. Write a program to to assign your age in a variable and find the age in months and days.
     */
    ...
    /*          
      25.	Write a program to input the values of the three sides of a triangle and find its area using the formula:
     ...
     */
     ...
     public static void problem25(){
        ...
        Area = Math.sqrt( (double) (s * (s - a) * (s - b) * (s - c) ));     // Math.sqrt() takes a double arguement and returns a double value.
